...
> - Pi: install [Pi](https://pi.dev/) (`npm i -g @earendil-works/pi-coding-agent`), run `pi`, then authenticate with `/login` (`pi auth --help` prints credentials for external clients)
